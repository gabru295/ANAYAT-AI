...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*𝚂𝙴𝙴𝙽 𝚈𝙾𝚄𝚁 𝚂𝚃𝙰𝚃𝚄𝚂 𝙱𝚈 ABDUR-RAHMAN-𝙰𝙸 🤍*",
...
BOT_NAME: process.env.BOT_NAME || "ABDUR-RAHMAN-AI",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "ABDUR-RAHMAN-AI",
...
OWNER_NAME: process.env.OWNER_NAME || "USER DEAD",
// add bot owner name
...
DEV: process.env.DEV || "923017919788",
